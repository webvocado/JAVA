...
public class LimitedTypeClass {
	...
	public static void main(String[] args) {
		...
		// 에러 메시지
		// : Bound mismatch : The type is not a valid substitute for the bounded parameter <T extends A> of the type D<T>
	    // D 클래스는 타입 매개변수를 A 클래스로 제한하고 있기 때문에,
		// X 클래스는 타입 매개변수로 사용할 수 없다
		// A,B,C 클래스는 타입 매개변수로 사용할 수 있다
		// (에러) D<X> d4 = new D<X>();
		...
		e3.setT( (byte) 127 ); // 127 을 int형으로 받기 때문에 형변환해준다.
